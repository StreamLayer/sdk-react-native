...
// https://github.com/facebook/react-native/blob/main/packages/react-native/ReactAndroid/src/main/java/com/facebook/react/uimanager/TouchTargetHelper.java
// 1. Change findTouchTargetView() - ignore StreamLayerView during finding touch target
// 2. Replace FLog with Log class for logging
 ...
 */
public class StreamLayerTouchTargetHelper {

  public static final String TAG = "StreamLayerTouchTargetHelper";
  ...
  private static View findTouchTargetView(
    ...
    if (allowReturnTouchTargetTypes.contains(TouchTargetReturnType.CHILD)
      ...
      if (viewGroup instanceof StreamLayerView) {
        return null;
      }
  ...
  private static @Nullable View findTouchTargetViewWithPointerEvents(
    ...
    if (pointerEvents == PointerEvents.NONE) {
      ...
      if (pointerEvents != PointerEvents.AUTO) {
        Log.w(TAG, "Unknown pointer event type: " + pointerEvents.toString());
      }
